Feature: Yo Como Cliente, deseo poder visualizar los datos de la función de una película determinada, ya que de esa manera puedo decidir mejor cual es más conveniente comprar, y saber la hora y sala de esta en particular.
